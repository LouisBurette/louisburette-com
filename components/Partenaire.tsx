  ...
  return (
    <section style={{ padding: '80px 48px', background: '#0E2215', color: '#F5EFE5', borderBottom: '3px solid #1A1714' }}>
      ...
      <div style={{ display: 'flex', gap: '64px', alignItems: 'center', flexWrap: 'wrap' }}>
        {/* Logo placeholder */}
        <div style={{ flexShrink: 0, width: '210px', height: '210px', border: '3px solid #F5EFE5', background: '#F5EFE5', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', transform: 'rotate(-1.5deg)', boxShadow: '8px 8px 0 #7FB069' }}>
          <span style={{ fontSize: '12px', color: '#1A1714', fontWeight: 700, textAlign: 'center', padding: '16px', opacity: 0.4 }}>Logo Team for the Planet</span>
        </div>
        <div style={{ flex: 1, minWidth: '320px' }}>
          ...
          <a href="https://team-planet.com" target="_blank" rel="noreferrer" style={{ display: 'inline-block', fontSize: '12px', fontWeight: 700, color: '#7FB069', textDecoration: 'none', letterSpacing: '0.06em', textTransform: 'uppercase', borderBottom: '2px solid rgba(127,176,105,0.4)', paddingBottom: '2px' }}>{t('link')}</a>
        </div>
      </div>
